...
\input{./secs/4_0-bldc_prop_model.tex}
\input{./secs/4_1-small_perturbation_model.tex}

%===============================================================================
\newpage
\part{Control}

\input{secs/5-control_model.tex}
%===
\section{Adaptive Robust Control Designs}
\subsection{Direct Adaptive Robust Control Design (ARC)}
