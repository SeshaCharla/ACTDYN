...
$u$ will be considered to be the actual input to the system and system identification with the propeller. The input is implemented by inverting the non-linear filter.
