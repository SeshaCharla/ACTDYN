...
The moment data has more variation from model due to the un-modelled aerodynamic effects such as aerodynamic-flutter. Thus, we have the estimates of force coefficients:
